	...
	<main class="container mx-auto px-6 py-8">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
			...
			>
				<div class="flex items-center justify-between">
					<div>
						<p class="text-gray-300 text-sm">Total Scripts</p>
		...
		<div class="bg-white/10 backdrop-blur-md rounded-lg p-8 border border-white/20 mb-8">
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
				...
				>
					...
					<div>{generating ? 'Generating...' : 'Generate Scripts'}</div>
				</button>
		...
		<div class="bg-white/5 backdrop-blur-md rounded-lg p-6 border border-white/10">
			<h3 class="text-xl font-bold text-white mb-2">Welcome to AllAboutMe!</h3>
			<p class="text-gray-300">
				Your AI-powered video generation platform. Generate scripts, create videos, and publish to
				multiple platforms - all from one place.
			</p>
		</div>
	</main>
</div>
